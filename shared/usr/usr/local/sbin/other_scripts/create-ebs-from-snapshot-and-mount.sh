...
#
EBS_ATTACH_DEVICE="/dev/sdf"

#
# The snapshot ID
# Values provided by the user-data override this setting
#
EBS_VOL_FROM_SNAPSHOT_ID=`/usr/local/sbin/other_scripts/ec2-describe-snapshots-current.rb` # e.g. snap-2b74b841
...
start|"")
  ...
  then
    ...
    sed -i "s/\$VOL1/$VOL_ID/g" /etc/init.d/aws_ebs_mount
