...
#
EBS_ATTACH_DEVICE="/dev/sdh"

#
# The snapshot ID
# Values provided by the user-data override this setting
#
EBS_VOL_FROM_SNAPSHOT_ID=`/usr/local/sbin/other_scripts/ec2-describe-snapshots-current-3.rb` # e.g. snap-2b74b841
...
start|"")
  ...
  then
    ...
    sed -i "s/\$VOL3/$VOL_ID/g" /etc/init.d/aws_ebs_mount
